...
{{Form::open(array('action' => 'AdministratorController@store_mhs', 'enctype' => 'multipart/form-data')) }}
	...
	<div class="form-group">
		...
		{{ Form::select('dosen_id', $dosen, Input::old('dosen_id'), array('class' => 'form-control')) }}
	</div>
	<div class="form-group">
